...
| DEC-014 | 2026-09-09 | M2 | Freeze the model. No further modelling before the presentation | The audit set has already informed two decisions; a third selection pass would compromise what can honestly be claimed | DEC-012, EXP-005 | Day 2 is presentation and rehearsal only | **Superseded by DEC-015** |
| DEC-015 | Final freeze | Team | Freeze EXP-010 as the primary result and use 45/50 paired wins as the safe headline | `joint_sweep.json` contains complete tuned/control trial arrays and independent arithmetic re-aggregation agrees | EXP-010; `candidate/verify_frozen_results.py` | No tuning or scientific reruns; auxiliary provenance-limited claims are excluded | **Accepted — binding** |
| DEC-016 | Final freeze | Team | Retain legacy `stage1_madrid.pkl` unchanged and add a distinct EXP-010 package | Legacy artifact is top-30 only; EXP-010 requires top-30/top-45 state, class offsets and a budget schedule | `exp010_stage1_madrid.pkl`; reload check | Packaging corrected without changing science or overwriting provenance | **Accepted — binding** |
| DEC-017 | Final freeze | Team | Classify Gate4 E1 FALSIFIED, E2 INCONCLUSIVE, E3 FALSIFIED | E2 +0.004953 missed +0.0100; E3 validator stopped at Original-tree Git gate before reconstruction | Gate4 frozen reports | E3 is not a success and has no full independent scientific validation | **Accepted — binding** |
| DEC-018 | Final freeze | Team | Treat the organiser/local RF baseline discrepancy as unresolved | Source was unchanged, but package/input provenance is incomplete and does not establish a cause | baseline discrepancy audit | Do not claim exact organiser reproduction or attribute the gap to a specific library change | **Accepted — binding; supersedes causal language in DEC-003/006** |
