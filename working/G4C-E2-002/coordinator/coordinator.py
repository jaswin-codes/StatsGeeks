"""G4C-E2-002 preparation coordinator.
...
ANCHORS = {
    ...
    "closed_e2_inventory_sha256": "46cdbabcd98754f9b879250090359d29a8a64861b32887ae8e7b24b423007436",
...
def dry_run():
    ...
    histories = [
        ...
        inventory_verify(ROOT / "working/G4C-E2-001/artifact_hash_manifest.json", ANCHORS["closed_e2_inventory_sha256"]),
    ]
    ...
    if (ROOT / "working/G4C-E2-001").resolve() == RUN.resolve() or not (ROOT / "working/G4C-E2-001/STOP_REASON.md").is_file():
        raise RuntimeError("Closed run identity contamination")
