...
if keyring >= 0:
    ...
    if added >= 0:
        # Outlast the next episode's runtime verification/import/transport time:
        # expiry must not masquerade as cross-episode keyring isolation.
        assert libc.syscall(250, 15, added, 300) == 0
