# Pixel Prophets — Coordinate-RF

**Current approved deliverables:** [Presentation](presentation.pptx) · [PDF](presentation.pdf) · [Written justification](written_explanation/written_justification.txt) · [Team logo](assets/pixel_prophets_logo.png).

The approved ten-slide PPTX and revised justification replace earlier presentation deliverables. No PDF was supplied in `new/`; this PDF was exported directly from the approved PPTX with PowerPoint. Scientific files remain unchanged. Presentation/documentation distribution entries alone were refreshed; the prior distribution seal is archived outside this folder.
...
| Path | Purpose |
|---|---|
| `presentation.pptx`, `presentation.pdf` | Approved final ten-slide deck and matching PowerPoint PDF export |
| `written_explanation/` | Approved revised written justification |
| `assets/pixel_prophets_logo.png` | Approved Pixel Prophets team logo |
...
research supervision is unconfirmed. The approved revised explanation must be checked against the
applicable organizer word limit before upload; no editorial shortening was authorized.
There is one target city, historical audit exposure and no independent organizer
held-out validation. Clean installation, new inference execution and presentation-machine visual
review are not certified by this synchronization pass. PDF export is complete, but
human inspection of fonts, figures and clipping remains required. Source-trained reusable model
export requirements versus a cached source probability prior also need confirmation.

## Acknowledgements and license
Pixel Prophets acknowledges the organizers for data and notebooks and the open-source
